...
namespace DurableTask.PostgresSQL
{
    ...
    /// <summary>
    /// Tracks payload IDs for events to avoid duplication
    /// </summary>
    internal class EventPayloadMap
    {
        ...
        {
            // DTFx sometimes creates different object references between messages and history events
        ...
        {
            // Sequential GUIDs for easier debugging
            return new Guid(DTUtils.GetTaskEventId(e), (short)e.EventType, this.sequenceNumber++, this.timestamp);
        }
    }

    /// <summary>
    /// Extended work item with PostgreSQL-specific data
    /// </summary>
    internal class ExtendedOrchestrationWorkItem : TaskOrchestrationWorkItem
    {
